...
const ICONS: Record<ReaderIconName, IconPath[]> = {
  ...
  'websearch': [
    { d: 'M12 2a10 10 0 0 0-9.5 7h19A10 10 0 0 0 12 2z', type: 'path' },
    { d: 'M12 22a10 10 0 0 0 9.5-7h-19A10 10 0 0 0 12 22z', type: 'path' },
    { d: 'M12 2v20', type: 'line' },
    { d: 'M2 12h20', type: 'line' },
    { d: 'M4 12a8 8 0 0 1 16 0', type: 'path' },
    { d: 'M4 12a8 8 0 0 0 16 0', type: 'path' },
    // Search bar overlay
    { d: 'M4 10h16v4H4z', type: 'path' },
    // Search icon inside bar
    { d: 'M18 12l-2-2', type: 'line' },
    { d: 'M15 11a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3z', type: 'path' }
  ],
  'globe': [
